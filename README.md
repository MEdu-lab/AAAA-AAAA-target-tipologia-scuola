...
- "\\newcommand{\\authorlist}{\\begin{minipage}{0.3\\textwidth}\n        \\centering\n\
  \        \\textbf{Pietro Barale}\\\\\\textit{operatore, diplomato in Musica Applicata\
  \ alle immagini, Conservatorio di Santa Cecilia, Roma}\n      \\end{minipage}\\\
  hfill\\begin{minipage}{0.3\\textwidth}\n        \\centering\n        \\textbf{Giulio\
  \ Romano De Mattia}\\\\\\textit{operatore, diplomato in Musica Elettronica, Conservatorio\
  \ di Santa Cecilia, Roma}\n      \\end{minipage}\\hfill\\begin{minipage}{0.3\\textwidth}\n\
  \        \\centering\n        \\textbf{Marco Di Gasbarro}\\\\\\textit{coordinatore,\
  \ dottorando in Composizione e Performance Musicale, Conservatorio di Ferrara}\n\
  \      \\end{minipage}}"
